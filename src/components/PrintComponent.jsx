        ...
        <>
            <thead className='d-flex justify-content-center'>
                <header className='h-32 d-flex justify-content-center align-items-center'>
                    <img src={PrintIcon} alt="Print" className="h-16  px-7 me-2 print-preview-button print-d-none" onClick={printAction} />
                    <img src={DownloadIcon} alt="Download" className="h-14 px-7 print-preview-button print-d-none" onClick={createPdfAction} />
                </header>
            </thead>
            <tbody>
                <tr>
